...
const workPlace = () => {
  return (
    ...
    <div className='grid sm:grid-cols-12 grid-cols-1 gap-1'>
      <div className='min-h-[100px] sm:col-span-4 shadow bg-gradient-to-tl from-transparent via-violet-400/30 to-transparent p-5'>
      ...
      <div className='min-h-[100px] shadow sm:col-span-4 bg-gradient-to-tr from-transparent via-violet-400/30 to-transparent p-5 h-full'>
      ...
      <div className='min-h-[100px] sm:col-span-4 shadow p-5 bg-gradient-to-tl from-transparent via-violet-400/30 to-transparent'>
